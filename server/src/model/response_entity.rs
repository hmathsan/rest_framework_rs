...
use super::{enums::status_code::StatusCode, Response};
...
// TODO: Make builder with obligatory fields. ref https://dev.to/mindflavor/rust-builder-pattern-with-types-3chf
